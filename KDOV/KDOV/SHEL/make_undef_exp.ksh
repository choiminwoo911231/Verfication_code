#!/usr/bin/ksh
#BSUB -J OBS_UNDEF_EXP
#BSUB -q normal_p@maru                                                          
#BSUB -o UNDEF_EXP.out                                                          
#BSUB -e UNDEF_EXP.err                                                          
#BSUB -M 50GB 
source /usr/share/Modules/init/ksh
 ...
 export obslist=${ilist1}                                                        
  ifort -mcmodel=large -o $exe_path/make_undef_exp_${obslist}.exe $exe_path/make_undef_obs_nosat.f90 -I/opt/kma/kma_lib/apps/netcdf-fortran/4.5.2/INTEL/200/include -L/opt/kma/kma_lib/apps/netcdf-fortran/4.5.2/INTEL/200/lib -lnetcdf -lnetcdff
  ${exe_path}/make_undef_exp_${obslist}.exe                                     
 done 
