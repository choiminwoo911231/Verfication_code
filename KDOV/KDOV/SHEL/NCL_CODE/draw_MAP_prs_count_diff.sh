...
if ("${list}" .eq. "gpsro") then                                                
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_DIFF_${list}_"+"BA"+"_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
else                                                                            
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_DIFF_${list}_${var_idx[$nvdx]}_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
end if                                                                          
