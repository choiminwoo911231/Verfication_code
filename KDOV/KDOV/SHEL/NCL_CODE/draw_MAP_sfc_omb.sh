...
if ("${list}" .eq. "grndgnss") then
 outfig  = "${FIGDIR}/MAP/OB4DA_MAP_${mdl_name[$nmdl]}_${list}_${SDATE}_${EDATE}_${var_name[$nvar]}"
else
 outfig  = "${FIGDIR}/MAP/OB4DA_MAP_${mdl_name[$nmdl]}_${list}_${var_idx[$nvdx]}_${SDATE}_${EDATE}_${var_name[$nvar]}"
end if
print("outfig :"+outfig)
...
EOF
ncl -Q -n draw_map_sfc.ncl
rm -f draw_map_sfc.ncl
