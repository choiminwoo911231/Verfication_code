...
# export OUTDIR="/h3/home/kiaps/k-da-de05/DIAG/DATA/OUT/"
 ...
 mdl_name=( "CTL" "EXP" )
 idx=( "B" "B" )
 var_name=( "OmB_DIFF" "CmB_DIFF" )
 var_name1=( "BKG_DIFF" "BKG_DIFF" )
...
cat > draw_map_chn_mean_diff.ncl << EOF
...
outfig  = "${FIGDIR}/MAP/OB4DA_MAP_${list}_ch"+ch_num+"_"+prs_nnum+"hPa_${SDATE}_${EDATE}_${var_name[$nvar]}"
print("outfig :"+outfig)
 ...
 ctl1 = ctl0->${idx[$nvar]}(:,{ch_num},:,0:119)
 exp1 = exp0->${idx[$nvar]}(:,{ch_num},:,0:119)
 ctl1@_FillValue = -999.
...
;=================================
  ...
  res@tiMainString   = "${list1} ch"+ch_num+"     ${EXP_NAME}-${CTL_NAME}"
...
EOF
ncl -Q -n draw_map_chn_mean_diff.ncl
rm -f draw_map_chn_mean_diff.ncl
