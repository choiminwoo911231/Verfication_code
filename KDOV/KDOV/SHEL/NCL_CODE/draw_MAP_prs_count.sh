...
cat > draw_map_count_prs.ncl << EOF
load "$NCARG_ROOT/lib/ncarg/nclscripts/csm/gsn_code.ncl"
load "$NCARG_ROOT/lib/ncarg/nclscripts/csm/gsn_csm.ncl"
load "$NCARG_ROOT/lib/ncarg/nclscripts/csm/contributed.ncl"
if ("${list}" .eq. "gpsro") then                                                
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[0]}_${list}_"+"BA"+"_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
 outfig2  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[1]}_${list}_"+"BA"+"_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
else                                                                            
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[0]}_${list}_${var_idx[$nvdx]}_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
 outfig2  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[1]}_${list}_${var_idx[$nvdx]}_${prs_idx[$nprs]}hPa_${SDATE}_${EDATE}"
end if                                                                          
 ...
 elseif  (diffmax1 .ge. 100 .and. diffmax1 .lt. 500) then                       
    levspc = 10                                                                 
 elseif  (diffmax1 .ge. 50 .and. diffmax1 .lt. 100) then                        
    levspc = 5           
 elseif  (diffmax1 .ge. 20 .and. diffmax1 .lt. 50) then                        
    levspc = 2                                                        
 else                                                                           
    levspc = 1                                                                  
 end if   
...
EOF
ncl -Q -n draw_map_count_prs.ncl
rm -f draw_map_count_prs.ncl
