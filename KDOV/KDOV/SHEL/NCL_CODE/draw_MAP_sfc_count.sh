...
if ("${list}" .eq. "grndgnss") then
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[0]}_${list}_${SDATE}_${EDATE}"
 outfig2  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[1]}_${list}_${SDATE}_${EDATE}"
else
 outfig1  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[0]}_${list}_${var_idx[$nvdx]}_${SDATE}_${EDATE}"
 outfig2  = "${FIGDIR}/MAP_COUNT/OB4DA_MAP_COUNT_${mdl_name[1]}_${list}_${var_idx[$nvdx]}_${SDATE}_${EDATE}"
end if
...
print("outfig2 :"+outfig2)
 ...
 if (diffmax1 .ge. 40000 .and. diffmax1 .lt. 100000) then                         
    levspc = 1000
 elseif (diffmax1 .ge. 20000 .and. diffmax1 .lt. 40000) then                         
    levspc = 600                                                                  
 elseif (diffmax1 .ge. 10000 .and. diffmax1 .lt. 20000) then                         
    levspc = 400                                                                                
 elseif (diffmax1 .ge. 8000 .and. diffmax1 .lt. 10000) then                         
    levspc = 200                                                                
...
;-------------------------------------------------------
  ...
  wks2 = gsn_open_wks("png", outfig2)

  gsn_define_colormap(wks1,"WhViBlGrYeOrRe")                                    
  gsn_define_colormap(wks2,"WhViBlGrYeOrRe")                                    
